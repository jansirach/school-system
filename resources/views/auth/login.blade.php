...
<form method="POST" action="{{ route('login') }}" class="shadow rounded px-8 pt-6 pb-8 mb-4" style="background-color: rgba(255, 185, 0, 0.8);">
        @csrf

        <div class="flex justify-center mb-4">
        <img class="h-24 w-24 mb-4" src="https://www.spud.edu.ph/assets/logo/spud_logo.png" alt="Logo">
        </div>
