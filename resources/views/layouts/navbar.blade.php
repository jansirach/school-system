<div class="bg-green-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    ...
    <img class="h-6 w-6 mr-2" src="https://www.spud.edu.ph/assets/logo/spud_logo.png" alt="Logo">
        <span class="font-semibold text-sm sm:text-xl tracking-tight">SPUD MANAGEMENT SYSTEM</span>
    </div>
    <div class="relative">
        @auth
            ...
            <div class="bg-green-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
